...
public class AnimatedPieViewConfig2 implements Serializable {
     ...
     */
    public AnimatedPieViewConfig2 setDrawStrokeOnly(boolean stroke) {
        isStroke = stroke;
     ...
     */
    public AnimatedPieViewConfig2 setStrokeWidth(int strokeWidth) {
     ...
     */
    public AnimatedPieViewConfig2 setStartAngle(float startAngle) {
     ...
     *                     出现意料之外的效果
     */
    private AnimatedPieViewConfig2 setInterpolator(Interpolator interpolator) {
     ...
     * @param duration 动画时间
     */
    public AnimatedPieViewConfig2 setDuration(long duration) {
    ...
    /**
     * 添加一个数据数组
     * <p>see @{@link AnimatedPieViewConfig2#addData(IPieInfo)}
     *
     * @param infos 数据实体数组
     */
    public AnimatedPieViewConfig2 addDatas(@NonNull List<? extends IPieInfo> infos) {
     ...
     * @param info 数据实体
     */
    public AnimatedPieViewConfig2 addData(@NonNull IPieInfo info) {
     ...
     */
    public AnimatedPieViewConfig2 addData(@NonNull IPieInfo info, boolean autoDesc) {
    ...
    protected AnimatedPieViewConfig2 setReApply(boolean reApply) {
    ...
    public AnimatedPieViewConfig2 setTouchScaleSize(float touchScaleSize) {
    ...
    /**
     * 设置点击浮现动画时间
     * <p>缩小归位动画时间{@link AnimatedPieViewConfig2#setTouchScaleDownDuration(long)}
     *
     * @param touchScaleUpDuration 时间
     */
    public AnimatedPieViewConfig2 setTouchScaleUpDuration(long touchScaleUpDuration) {
    ...
    /**
     * 设置缩小归位动画时间
     * <p>点击放大动画时间{@link AnimatedPieViewConfig2#setTouchScaleUpDuration(long)} (long)}
     *
     * @param touchScaleDownDuration 时间
     */
    public AnimatedPieViewConfig2 setTouchScaleDownDuration(long touchScaleDownDuration) {
     ...
     */
    public AnimatedPieViewConfig2 setTouchShadowRadius(float touchShadowRadius) {
     ...
     */
    public AnimatedPieViewConfig2 setTouchExpandAngle(float touchExpandAngle) {
     ...
     * @return
     */
    public AnimatedPieViewConfig2 setTouchAnimation(boolean touchAnimation) {
     ...
     * <p>文字绘制开关：{@link AnimatedPieViewConfig2#setDrawText(boolean)}
     */
     ...
     */
    public AnimatedPieViewConfig2 setPieRadiusScale(@FloatRange(from = 0.0f, to = 1.0f) float pieRadiusScale) {
    ...
    /**
     * 是否绘制文字描述
     * <p>当{@link AnimatedPieViewConfig2#addData(IPieInfo, boolean)}第二个参数为true时，文字描述强制为显示百分比
     * <p>当{@link AnimatedPieViewConfig2#addData(IPieInfo, boolean)}第二个参数为false时，文字描述显示为数据的desc{@link IPieInfo#getDesc()}
     */
     ...
     */
    public AnimatedPieViewConfig2 setDrawText(boolean drawText) {
     ...
     * @param <T>                 传入接口{@link IPieInfo}的数据实体类，缺省值默认为Object
     */
    public <T extends IPieInfo> AnimatedPieViewConfig2 setOnPieSelectListener(OnPieSelectListener<T> onPieSelectListener) {
     ...
     */
    public AnimatedPieViewConfig2 setTextMarginLine(float textMarginLine) {
     ...
     */
    public AnimatedPieViewConfig2 setTextSize(int textSize) {
     ...
     */
    public AnimatedPieViewConfig2 setTextPointRadius(int textPointRadius) {
     ...
     */
    public AnimatedPieViewConfig2 setTextLineStrokeWidth(int textLineStrokeWidth) {
     ...
     */
    public AnimatedPieViewConfig2 setTextLineTransitionLength(int textLineTransitionLength) {
     ...
     */
    public AnimatedPieViewConfig2 setTextLineStartMargin(int textLineStartMargin) {
     ...
     */
    public AnimatedPieViewConfig2 setDirectText(boolean directText) {
     ...
     * 设置甜甜圈是否允许触碰放大
     */
    public AnimatedPieViewConfig2 setCanTouch(boolean canTouch) {
     ...
     * @param splitAngle
     */
    public AnimatedPieViewConfig2 setSplitAngle(float splitAngle) {
     ...
     */
    public AnimatedPieViewConfig2 setFocusAlphaType(@FocusAlpha int focusAlphaType) {
     ...
     */
    public AnimatedPieViewConfig2 setFocusAlphaType(@FocusAlpha int focusAlphaType, @FloatRange(from = 0, to = 255) float alphaCutDown) {
     ...
     */
    public AnimatedPieViewConfig2 setStrokePaintCap(@NonNull Paint.Cap strokePaintCap) {
     ...
     */
    public AnimatedPieViewConfig2 setConfig(AnimatedPieViewConfig2 config) {
        if (config != null) {
