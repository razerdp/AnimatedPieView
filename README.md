...
| 绘制文字       | setDirectText(true)      |   ![pie_with_text](https://github.com/razerdp/AnimatedPieView/blob/master/art/pie_with_text.gif)    |
...
| 焦点甜甜圈效果 (反向)      | setFocusAlphaType(AnimatedPieViewConfig.FOCUS_WITH_ALPHA_REV,150)    |   ![pie_click_with_focus_alpha_type_rev](https://github.com/razerdp/AnimatedPieView/blob/master/art/pie_click_with_focus_alpha_type_rev.gif)    |
| 焦点甜甜圈效果       | setFocusAlphaType(AnimatedPieViewConfig.FOCUS_WITH_ALPHA,150)    |   ![pie_click_with_focus_alpha_type](https://github.com/razerdp/AnimatedPieView/blob/master/art/pie_click_with_focus_alpha_type.gif)    |
